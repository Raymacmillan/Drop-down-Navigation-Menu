...
})({"jImQu":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "f4b09d0c5d038ca5";
...
},{}],"8wlU4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
const arrowUP = new URL(require("66b1a67b5253f28c"));
const arrowDown = new URL(require("f15cb5fae52ba0bb"));
const menuImages = {
    open: new URL(require("6fdbfcf4d568551d")).toString(),
    close: new URL(require("889fb04d54e2395e")).toString()
};
const menu = (0, _jqueryDefault.default)(".mobile-menu");
const navLinks = (0, _jqueryDefault.default)(".nav-links");
const navLinksContainer = (0, _jqueryDefault.default)(".nav-links-container");
const header = (0, _jqueryDefault.default)("HEADER");
...
const helper = (icon, subLinks, isSlideDown = null)=>{
    if (isSlideDown === null) {
        if (subLinks.css("display") === "none") {
            ...
            subLinks.slideDown({
                start: function() {
                    (0, _jqueryDefault.default)(this).css({
                        display: "flex"
                    });
                }
            });
...
function toggleSub(target) {
    ...
    helper(icon, (0, _jqueryDefault.default)(sublinksContainer));
}
window.addEventListener("click", ({ target  })=>{
    const sublinksContainers = document.querySelectorAll(".sub-links");
    for(let i = 0; i < sublinksContainers.length; i++)if (!sublinksContainers[i].contains(target) && sublinksContainers[i].parentNode.querySelector("a") !== target) {
        const icon = sublinksContainers[i].parentNode.querySelector("a img");
        helper(icon, (0, _jqueryDefault.default)(sublinksContainers[i]), false);
    }
});
...
function toggleMenuIcon() {
    ...
    if (menuIcon.src.includes("icon-menu")) menuIcon.src = menuImages.close;
    else menuIcon.src = menuImages.open;
}
...
},{"jquery":"hgMhh","66b1a67b5253f28c":"5BEHq","f15cb5fae52ba0bb":"c6886","6fdbfcf4d568551d":"kS2We","889fb04d54e2395e":"8mLzH","@parcel/transformer-js/src/esmodule-helpers.js":"7Rzro"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}],"5BEHq":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("l0tFE") + "icon-arrow-up.3b9faf7a.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"jyf1D"}],"jyf1D":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"c6886":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("l0tFE") + "icon-arrow-down.deff4496.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"jyf1D"}],"kS2We":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("l0tFE") + "icon-menu.a28b6156.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"jyf1D"}],"8mLzH":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("l0tFE") + "icon-close-menu.94ea3251.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"jyf1D"}],"7Rzro":[function(require,module,exports) {
...
},{}]},["jImQu","8wlU4"], "8wlU4", "parcelRequire3d04")

//# sourceMappingURL=index.5d038ca5.js.map
